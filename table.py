...
def get_state_abbr(statefp):
    states = {'09': 'CT', '51': 'VA', '50': 'VT', '19': 'IA', '26': 'MI', '35': 'NM', '04': 'AZ', '02': 'AK', '25': 'MA', '23': 'ME', '01': 'AL', '20': 'KS', '21': 'KY', '48': 'TX', '05': 'AR', '46': 'SD', '47': 'TN', '08': 'CO', '45': 'SC', '42': 'PA', '29': 'MO', '40': 'OK', '41': 'OR', '27': 'MN', '18': 'IN', '28': 'MS', '24': 'MD', '39': 'OH', '38': 'ND', '72': 'PR', '30': 'MT', '06': 'CA', '11': 'DC', '10': 'DE', '13': 'GA', '12': 'FL', '15': 'HI', '22': 'LA', '17': 'IL', '16': 'ID', '55': 'WI', '54': 'WV', '31': 'NE', '56': 'WY', '37': 'NC', '36': 'NY', '53': 'WA', '34': 'NJ', '33': 'NH', '32': 'NV', '49': 'UT', '44': 'RI'}
...
def cdistrict_geometry():
    simplify = get_simplify_factor(request.args.get('zoom'))
    districts = c.execute('SELECT id, statefp, cd114fp, geoid, namelsad, ST_AsText(ST_Simplify(geom, %s)) from districts', (simplify,))
...
def cdistrict_bbox():
    ...
    districts = c.execute('SELECT id, statefp, cd114fp, geoid, namelsad, ST_AsText(ST_Simplify(geom, %s)) from districts WHERE ST_MakeEnvelope(%s,%s,%s,%s) && geom', [simplify] + bounds)
    districts = c.fetchall()
